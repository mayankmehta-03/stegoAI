...
secretin = np.array(Image.open(args['secret_image']).convert('RGB').resize((224, 224))).reshape(1,224,224,3)/255.0
coverin = np.array(Image.open(args['cover_image']).convert('RGB').resize((224, 224))).reshape(1,224,224,3)/255.0
